File Manager (PHP/Laravel/PostgreSQL) Выполнил Александр Аблин
...
Ключевые функции:
    ...
    Хранение: Использование БД для хранения.
    RBAC (Role-Based Access Control): * User: Загрузка, просмотр и скачивание только своих файлов.
    Admin: Полный аудит системы (скачивание файлов всех пользователей), запрет на личную загрузку.
